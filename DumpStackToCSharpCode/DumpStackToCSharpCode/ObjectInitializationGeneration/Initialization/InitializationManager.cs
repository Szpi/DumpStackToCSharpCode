...
namespace RuntimeTestDataCollector.ObjectInitializationGeneration.Initialization
{
    public class InitializationManager
    {
        ...
        private readonly NullableExpressionGenerator _nullableExpressionGenerator;
        ...
        public InitializationManager(TypeAnalyzer typeAnalyzer,
                                     ...
                                     NullableExpressionGenerator nullableExpressionGenerator)
        {
            ...
            _nullableExpressionGenerator = nullableExpressionGenerator;
        }
        ...
        public (ExpressionSyntax generatedSyntax, TypeCode mainTypeCode) GenerateForMainObject(ExpressionData expressionData, bool isParentImmutableType = false)
        {
            ...
            {
                generatedSyntaxForMainObject = HandleNullableType(expressionData, generatedSyntax, expressionTypeCode, argumentSyntax);
            }
        ...
        private ExpressionSyntax HandleNullableType(
            ExpressionData expressionData, 
            SeparatedSyntaxList<ExpressionSyntax> generatedSyntax,
            TypeCode expressionTypeCode,
            List<ExpressionSyntax> argumentSyntax)
        {
            if (_typeAnalyzer.IsPrimitiveType(expressionTypeCode))
            {
                return _nullableExpressionGenerator.Generate(generatedSyntax.FirstOrDefault(), expressionData.Type);
            }
            
            var complexObject  = _objectInicializationExpressionGenerator.GenerateForObject(expressionData.Type.TrimEnd('?'), generatedSyntax, argumentSyntax);
            return _nullableExpressionGenerator.Generate(complexObject, expressionData.Type); ;
        }
